                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="brandName" class="form-control" required value="{{old('brandName')}}">
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="form-group">
