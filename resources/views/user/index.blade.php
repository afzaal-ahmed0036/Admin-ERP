...
<section>
    @if(in_array("users-add", $all_permission))
        <div class="container-fluid">
            <a href="{{route('user.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{trans('file.Add Customer')}}</a>
        </div>
    @endif
            ...
            <tbody>
                ...
                <tr data-id="{{$user->id}}">
                    ...
                    <?php $role = DB::table('roles')->find($user->role_id);
                        $form = App\FormUser::where('user_id',$user->id)->first();
                    ?>
                    <td>{{ $role->name }}</td>
                    @if($user->is_active)
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                	<a href="{{ route('show_forms', $user->id) }}" class="btn btn-link"><i class="fa fa-eye"></i> {{trans('file.View')}}</a>
                                </li>
                                <li>
